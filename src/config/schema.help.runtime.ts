...
export const RUNTIME_FIELD_HELP: Record<string, string> = {
  ...
  "tools.exec.reviewer.serviceTier":
    "Optional service tier for OpenClaw approval reviews: priority requests Fast processing on supported OpenAI Responses and ChatGPT/OAuth routes; default requests standard processing. Omit to preserve provider defaults. Priority may cost more and is subject to provider availability. Does not configure native Codex Guardian.",
