...
export function assertCronToolOwnershipInput(
  ...
  const job = isRecord(params.job) ? params.job : undefined;
  if (job && Object.hasOwn(job, "owner")) {
  ...
  if (
    action === "update" &&
    (Object.hasOwn(params, "declarationKey") || (job && Object.hasOwn(job, "declarationKey")))
  ) {
